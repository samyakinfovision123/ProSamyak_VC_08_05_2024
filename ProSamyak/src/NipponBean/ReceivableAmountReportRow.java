...
public class ReceivableAmountReportRow
{
	int receive_fromId;
	double janamount;
	double febamount;
	...
	ReceivableAmountReportRow(int receive_fromId,double janamount,double febamount,double maramount,double apramount,double mayamount,double junamount,double julamount,	double augamount,double sepamount,double octamount,	double novamount,double decamount,double beforeAprilAmount)
	{
