...
public class BrokerPurchasePersonServlet extends HttpServlet {
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws java.io.IOException {
	...
	BrokerPurchasePersonList brokerpurchaseperson_list = new BrokerPurchasePersonList();

    String action = req.getParameter("action");
    String company_id = req.getParameter("company_id");
    String brokerpurchaseperson_name = req.getParameter("BrokerPurchasePerson_name");
   ...
   // System.out.println("party_name="+party_name);
	...
	brokerpurchaseperson_list.getBrokerPurchasePersonIdName(company_id,brokerpurchaseperson_name,isNext);
      } 

	  
    }

    String lotlistXml = brokerpurchaseperson_list.toXml();
