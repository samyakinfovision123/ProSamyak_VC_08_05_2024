...
public class ReceiveIdNumberStockTransferServlet extends HttpServlet {
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws java.io.IOException {
	...
	ReceiveIdNoListStockTransfer receiveid_list = new ReceiveIdNoListStockTransfer();
    ...
    if ((action != null)) {
      ...
      if ("getSubGroupLedger".equals(action)) {
		...
		receiveid_list.getIdNumberStockTransfer(company_id,receive_no,isNext);
      } 
