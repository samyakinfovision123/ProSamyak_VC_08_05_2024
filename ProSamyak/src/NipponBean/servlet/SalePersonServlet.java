...
public class SalePersonServlet extends HttpServlet {
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws java.io.IOException {
	...
	SalePersonList saleperson_list = new SalePersonList();

    String action = req.getParameter("action");
    String company_id = req.getParameter("company_id");
    String saleperson_name = req.getParameter("SalePerson_name");
   ...
   // System.out.println("party_name="+party_name);
	...
	saleperson_list.getSalePersonIdName(company_id,saleperson_name,isNext);
      } 

	  
    }

    String lotlistXml = saleperson_list.toXml();
