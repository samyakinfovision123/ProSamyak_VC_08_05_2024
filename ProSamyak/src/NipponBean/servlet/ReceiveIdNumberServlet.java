...
public class ReceiveIdNumberServlet extends HttpServlet {
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse res) throws java.io.IOException {
	...
	ReceiveIdNoList receiveid_list = new ReceiveIdNoList();
    ...
    if ((action != null)) {
      ...
      if ("getSubGroupLedger".equals(action)) {
		...
		receiveid_list.getIdNumber(company_id,receive_no,isNext);
      } 
