...
String tableName[] = {
	                   "Asset", "Balance", "Capital", "Cash", "Financial_Transaction", "ForwardBooking", "Investment", "Ledger", "LedgerChangeLog", "Liability", "Loan", "Lot", "LotLocation", "Master_Account", "Master_Bank", "Master_CompanyParty", "Master_CostHeadGroup", "Master_CostHeadSubGroup", "Master_Currency", "Master_Location", "Master_LotCategory", "Master_LotSubCategory", "Master_Salesperson", "Master_SubGroup", "Master_Unit", "Master_User", "Payment_Details", "PhysicalVerification", "PN", "ProfitLoss", "Receive", "Seikisho", "Voucher"
					 };
...
for(int z=0; z<tableName.length; z++)
{
	String query="Select Distinct company_id from "+	tableName[z]+"";
	...
	*/
	...
	for( tempi=0;tempi<diffCompanyCount;tempi++)
	{
		...
		{
			out.print("97");
			query="Update "+tableName[z]+" set YearEnd_Id=? where company_id=?";
