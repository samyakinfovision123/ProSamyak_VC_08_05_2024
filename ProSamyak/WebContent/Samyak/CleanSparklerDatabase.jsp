...
//table39
	query="delete from Effective_Rate";
	pstmt_g = cong.prepareStatement(query);
	a = pstmt_g.executeUpdate();
	out.print("<br>Effective_Rate Data deleted");	

//table40
	query="delete from Order_Transaction";
	pstmt_g = cong.prepareStatement(query);
	a = pstmt_g.executeUpdate();
	out.print("<br>Order_Transaction Data deleted");	

//table41
	query="delete from Order_Sell";
	pstmt_g = cong.prepareStatement(query);
	a = pstmt_g.executeUpdate();
	out.print("<br>Order_Sell Data deleted");	
