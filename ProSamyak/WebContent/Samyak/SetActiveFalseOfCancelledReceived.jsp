...
Samyak/SetActiveFalseOfCancelledReceived.jsp?command=Samyak07
...
if(command.equals("Samyak07")){
    ...
    try	{
		...
		{ 
		 out.println("<font color=red> FileName : 	SetActiveFalseOfCancelledReceived.jsp<br>Bug No Samyak31 : "+ Samyak31);
		}
