...
Samyak/ConsignmentSystemRun_monday.jsp?command=Samyak07
...
if(command.equals("Samyak07")){
	...
	// 
		...
		String cgtSaleQuery = "SELECT ReceiveTransaction_Id FROM Receive R, Receive_Transaction RT where R.Purchase=0 And R.Receive_Sell=0 And R.Opening_Stock=0 And R.Active=1 And R.Return=0 and R.Receive_Id=RT.Receive_Id";
