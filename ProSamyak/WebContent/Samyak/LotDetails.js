...
function RenderMe(ele,divelestr)
{
	
	var divele=document.getElementById(divelestr);
	...
	//shiftTo(divele,offsetLeft+85,offsetTop+30);
	divele.style.left=offsetLeft+85+" px";
	divele.style.top=offsetTop+30+" px";
	divele.style.visibility="visible";
}

function HideMe(divelestr)
{
	//alert("Hello");
	var ele=document.getElementById(divelestr);
	//alert(ele);
...
function setlotDetails(lotXML) {
	...
	for (var I = 0 ; I < lots.length ; I++) {
	 ...
	 oCol.innerText="Financial Quantity";
	 ...
	 oRow.appendChild(oCol);
	 oCol.innerText="Physical Quantity";
