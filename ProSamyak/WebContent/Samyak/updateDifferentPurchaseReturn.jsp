...
for(int k=0; k<count; k++)
	...
	String return_invoice_no="A"+Voucher.getAutoNumber(cong,19,t_currency,"1");
	...
	pstmt_p.setBoolean (28, false);	//Receive_sell
	pstmt_p.setString (29,"0");	
	pstmt_p.setString (30,"1"); //1st yearend id given for fsd	
	pstmt_p.setString (31,"Samyaks ACPR");	
	pstmt_p.setString (32,"Samyaks ACPR");	
	...
	//conp.commit();
	out.print("<br><font color=red>Consignment Purchase returned="+Receive_id_new+"</font><br>");	
	}
