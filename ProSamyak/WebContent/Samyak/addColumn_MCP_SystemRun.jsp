...
Type in url:-/Samyak/addColumn_MCP_SystemRun.jsp?command=Samyak
...
try
{
	...
	query="ALTER TABLE Master_CompanyParty ADD PerDay_CreditLimit numeric DEFAULT  0";
	pstmt_p=conp.prepareStatement(query);
	int i=pstmt_p.executeUpdate();
	pstmt_p.close();

	query="Update Master_CompanyParty Set PerDay_CreditLimit=0";
	pstmt_p=conp.prepareStatement(query);
