...
query="Select count(*) as counter from  Receive as R, Receive_Transaction as RT where  R.Purchase=0 and R.Receive_Sell=1 and R.return=0 and Company_id="+company_id+" and R.Active=1 and RT.Active=1 and R.Receive_Id=RT.Receive_Id";
...
query="Select * from  Receive as R, Receive_Transaction as RT where  R.Purchase=0 and R.Receive_Sell=1 and R.return=0 and Company_id="+company_id+" and R.Active=1 and RT.Active=1 and R.Receive_Id=RT.Receive_Id";
