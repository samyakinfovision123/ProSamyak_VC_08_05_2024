...
<form name ="theForm" action ="Admin.jsp?command=Select" method ="post" onSubmit ="verify(this)">
<table align=center bordercolor=skyblue  border=1 cellspacing=2 cellpadding=2 >
<tr><th colspan=2>Control Panel</th></tr>
...
if(command.equals("Select"))
{
		 out.print("Inside Select");
			...
			response.sendRedirect("Menu.jsp?command=default&EntityID="+EntityID);			
}
