...
<TITLE> Edit Location </TITLE>
	<Body bgcolor=#FFD3A8>
		...
		%>
			...
			<IFRAME name=top  src="../Master/location.jsp?command=Default&message=Default" marginwidth="0" marginheight="10" hspace="0" vspace="0" frameborder="0" scrolling="no" width='100%'  height='15%'  >
			
			

			<IFRAME name=bottom  src="../Master/NewLocation.jsp?command=Default&lots=3&stock=no&invoicedate=<%=format.format(D4)%>&Receive_Id=0" marginwidth="0" marginheight="0" hspace="0" vspace="0" frameborder="0" scrolling="auto" width='100%' height='85%' >
