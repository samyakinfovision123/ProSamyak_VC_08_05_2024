...
<%=A.getMasterArrayAll(conp,"Companyparty","party_id","",company_id)%> </td></tr>
	...
	<input type=submit value='Edit Cgt Sale' name=command class='Button1' onmouseover="this.className='button1_over';" onmouseout="this.className='button1';">
</td>
</tr>
</table>
</form>			
...
if("Edit Cgt Sale".equals(command))
	{
...
{
query="Select * from Receive  where Receive_Date between ? and ? and Company_id=? and Purchase=0  and Receive_Sell=0 and Active=1 and Return=0 and Opening_Stock=0 and ProActive=0 and Consignment_ReceiveId=0 order by receive_date ,receive_no";
}
//receive=0 specifies that the receive is consignment receive
else{
query="Select * from Receive  where Receive_Date between ? and ? and Company_id=?  and Receive_FromId="+party_id+" and Purchase=0 and Receive_Sell=0 and Active=1 and Return=0 and Opening_Stock=0  and ProActive=0  and Consignment_ReceiveId=0  order by receive_date , receive_no";
}
...
<tr><th colspan=13>
Select Consignment Sale to Edit</th>
<tr>
<th>Sr No</th>
<th>No</th>
<th>To</th>
...
<td>
	<%=i++%></td>
<td><A href= "EditCgtSaleForm.jsp?command=CgtSaleEdit&receive_id=<%=Receive_id%>" target=_blank>
...
%>
<tr><td align=right colspan=7><b>Total</b></td>
