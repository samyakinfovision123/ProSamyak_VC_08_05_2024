...
{
errfound = false;
if(document.NewSubCategory.lotsubcategory_name.value == "")
			{
			alert("Please enter Sub Category's name properly.");
			document.NewSubCategory.lotsubcategory_name.focus();
			return errfound;
			}
		else{
		if(document.NewSubCategory.lotsubcategory_code.value == "")
			{
			alert("Please enter SubCategory Code properly.");
			document.NewSubCategory.lotsubcategory_code.focus();
			return errfound;
			}
		else
			{
...
<form name=NewSubCategory  action="UpdateSubCategory.jsp" method=post onsubmit="return Validate();">
<% 

String message=request.getParameter("message"); 
//String name   = request.getParameter("name"); 
int srno=1;
String selectquery ="Select * from Master_LotSubCategory where company_id=?"; 
...
<tr bgcolor=skyblue>
<th colspan=4>Add New Sub Category </th>
</tr>
...
%>
<%=A.getMasterArrayCondition(conp,"LotCategory","lotcategory_id","","where LotCategory_Name NOT IN ('Diamond','Jewelry') and Company_id="+company_id+" and Active=1")%>
...
<td colSpan=3><input type=text name=lotsubcategory_name size=25 ></td>
</tr>

<tr>
<td>Code <font class="star1">*</font></td>
<td colSpan=3><INPUT type=text name=lotsubcategory_code size=25 >
...
<tr>
<td>Description </td>
<td colSpan=3><INPUT type=text name=lotsubcategory_description size=25 >
<input type=hidden name=sr_no size=6 value='1'>
</td>
</tr>
...
<input type=submit name=command value='Add Sub Category' class='Button1'>
</td>
</tr>
