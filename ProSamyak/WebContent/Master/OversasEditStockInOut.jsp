...
String command=request.getParameter("command");
 System.out.print("<br>command=" +command);
try{
%>
...
<tr><td>
	<form action=OversasEditStockInOut.jsp name=f1 method=post >
...
<td>
	<%=++i%></td>
<td><A href= "../Master/OverseasEditStock_InOutForm.jsp?Receive_Id=<%=receive_id%>&StockTransfer_Type=<%=StockTransfer_Type%>&voucher_no=<%=voucher_no%>&command=Default&mesage=Default" target=_self><%=voucher_no%></td></td>
