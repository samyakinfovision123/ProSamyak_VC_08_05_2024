...
pn_exist++;}
pstmt_p.close();
//out.print("<br>221 pnv_id=" +pnv_id);
...
out.println(" <BR>366<font color=navy>Updated Successfully: ?</font>" +a691);
pstmt_p.close();
...
out.println(" <BR>401 <font color=navy>Added Successfully:</font> " +a322);
pstmt_p.close();
...
out.println(" <BR>427<font color=navy>Updated FT Successfully: ?</font>" +a209);
pstmt_p.close();
...
out.println(" <BR>458<font color=navy>Updated FT2 Successfully: ?</font>" +a242);
pstmt_p.close();
...
out.print("<br >488machine_name "+machine_name);
int aexp = pstmt_p.executeUpdate();
out.println(" <BR>490<font color=navy>Updated Successfully: ?</font>" +aexp);
pstmt_p.close();
...
out.println(" <BR>519<font color=navy>Updated FT Successfully: ?</font>" +aft1);
pstmt_p.close();
...
//out.print("<br >machine_name "+machine_name);
int aexp = pstmt_p.executeUpdate();
out.println(" <BR>579 <font color=navy>Updated Successfully: ?</font>" +aexp);
pstmt_p.close();
...
//out.print("<br >expft_id1 "+expft_id1);
int aft1 = pstmt_p.executeUpdate();
out.println(" <BR>614<font color=navy>Updated FT Successfully: ?</font>" +aft1);
pstmt_p.close();
...
int aft2 = pstmt_p.executeUpdate();
out.println(" <BR>643<font color=navy>Updated FT2 Successfully: ?</font>" +aft2);
pstmt_p.close();
...
//out.print("<br >machine_name "+machine_name);
int aexp = pstmt_p.executeUpdate();
out.println(" <BR>772<font color=navy>Updated Successfully: ?</font>" +aexp);
pstmt_p.close();
...
//out.print("<br >machine_name "+machine_name);
int aft2 = pstmt_p.executeUpdate();
out.println(" <BR>1007<font color=navy>Updated FT2 Successfully: ?</font>" +aft2);
pstmt_p.close();
...
%>
<html>
<title>Grands Lacs - Samyak Counsulting</title>
<script >
function CloseWindow()
{
	...
	{
		response.sendRedirect("../Finance/PurchasePayment.jsp?command=Default&message=Data Saved Successfully");
	}
	%>
	window.close();
	}
