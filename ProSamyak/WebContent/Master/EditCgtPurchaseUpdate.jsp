...
//System.out.println("110 consignment_no "+consignment_no);
...
//System.out.println("consignment_date"+consignment_date);
...
pstmt_p.setString(1,""+format.getDate(today_string));
rs_g=pstmt_p.executeQuery();
int exchange=0;
//System.out.println("<br>102121212121 exchange_rate is"+exchange_rate);
samyakerror=163;
while(rs_g.next())
		{
			exchange++;
...
//		out.print("if exchage_rate");
			int exchangerate_id= L.get_master_id(conp1,"Master_ExchangeRate");
		//System.out.println("181 exchangerate_id "+exchangerate_id);
...
//					out.print("<br>icurrencyid "+currencyid);
			...
			pstmt_p.setString(3,""+format.getDate(today_string));
...
//			out.print("<br> No of rows Master_ExchageRate "+a177);
		//exchangerate_id=exchangerate_id+1;
		}
...
//System.out.println("221 currency is"+currency);
String companyparty_id= request.getParameter("companyparty_id");
//System.out.println("223 company id is= "+companyparty_id);
...
//System.out.println("<br>subtotal"+subtotal);
double discount =0;
...
//System.out.println("367 insertLotLocation_id="+insertLotLocation_id);
...
//System.out.println("376 query" +query);
...
//System.out.println("391 before->phycarats"+phycarats);
	p++;
	}
...
phycaratsnew=phycarats-(old_quantity[i]-quantity[i]);
 //System.out.println("404 phycaratsnew "+phycaratsnew);
...
//System.out.println("436 Before Query <br>"+query);
...
if(lot_id[i].equals(newlot_id[i]) && location_id[i].equals(newlocation_id[i]))
	{
		...
		pstmt_p.setDouble(1,phycaratsnew);
...
//		out.print("<br>originalphy "+originalphy);
		...
		pstmt_p.setDouble(1,originalfin); 
...
//out.print("4444444444444444444444444444444444Update");
			...
			pstmt_p.setDouble(1,newlotlocationav_carats);
...
//			out.print("<br> Select LotLocation");
			...
			pstmt_p.setDouble(1,addlotlocationav_carat);
...
//		pstmt_p.setString (18,description);
...
newreceivetransaction_id++;
		...
		pstmt_p.setString(20,""+format.getDate(today_string)); 
		pstmt_p.setString(21,""+salesperson_id);
		
        pstmt_p.setString(22,""+purchasesalegroup_id);
		pstmt_p.setString(23,ref_no);
		pstmt_p.setString(24,description);
		pstmt_p.setString(25,receive_category_id);

		pstmt_p.setString(26,""+receive_id);
...
//response.sendRedirect("EditCgtPurchase.jsp?command=PurchaseReport&message=Data Saved Successfully");
