...
ErrLine="99";
		...
		String receive_no="",companyparty_id="",receive_companyid="",receive_byname="",receive_fromname="",duedays="",salesperson_id="",narr="",refno="",purchasesalegroup_id="",category_id="";
...
{ int t=i; t++;%>
	...
	<tr name=tr<%=i%>>
		...
		<td><%=originalQuantity[i]%></td>
		<td><%=returnQuantity[i]%></td>
		<td><%=str.mathformat(""+ghat[i],3)%></td>
		<td><%=quantity[i]%></td>
		...
		<td><%=str.mathformat(""+amount[i],d)%></td>

		<td><%=str.mathformat(""+Localamount[i],d)%></td>
		<td><%=lotDiscount[i]%>
...
<%}
	...
	<tr>
		...
		<td>&nbsp;</td>
		<td>&nbsp;</td>
		<td><%=str.format2(""+InvTotalAmount,d)%></td>
		<td><%=str.format2(""+InvTotalLocalAmount,d)%></td>
	</tr>
	<%
...
<script language="javascript">
	...
	<tr>
		...
		<td><%=str.format2(""+totalamount,d)%></td>
		<td><%=str.format2(""+totalLocalamount,d)%></td>
	</tr>
	<tr>
