...
//currency lock removed..Chanchal 25042006
...
boolean setPDFlag[]=new boolean[counter]; 
int status=0; 
...
pstmt_p.setString (12,user_id);	
pstmt_p.setString (13,machine_name);
pstmt_p.setBoolean (14,setPDFlag[i]);
...
//out.print("<BR>303");
//pstmt_p.setString (9,""+rlocalamt);	
//pstmt_p.setString (10,""+rdollaramt);
pstmt_p.setString (11,""+exchange_rate);
//out.print("<BR>306");
pstmt_p.setString (12,user_id);	
pstmt_p.setString (13,machine_name);
...
else
{
 ...
 out.println("<body background='../Buttons/BGCOLOR.JPG' ><br><center><font class='msgred'><b>Bank Currency Should Be Same as Transction Currency</b><br><input type=button name=command value='BACK' class='Button1' onClick='history.go(-1)'></center>");
	...
	conp.rollback();
	C.returnConnection(conp);
out.println("<br><font class='star1'><h2> FileName : ReceiptUpdate.jsp @@<br>Bug errLine="+errLine+"No Samyak284 :"+ Samyak284 +"</h2></font><input type=button name=command value='BACK' class='Button1' onClick='history.go(-1)'>");
}//catch Samyak284
}//if save
