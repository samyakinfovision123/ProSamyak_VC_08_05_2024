...
try	{conp=C.getConnection();
	...
	out.println("<font color=red> FileName : Cost.jsp<br>Bug No e31 : "+ e31);}
...
{
errfound = false;
if(document.NewCostHeadGroup.costheadgroup_name.value == "")
			{
			alert("Please enter  Name Properly.");
			document.NewCostHeadGroup.costheadgroup_name.focus();
			return errfound;
			}
		else{
		if(document.NewCostHeadGroup.costheadgroup_code.value == "")
			{
			alert("Please enter Code Properly.");
			document.NewCostHeadGroup.costheadgroup_code.focus();
			return errfound;
			}
		else
			{
...
<form name=NewCostHeadGroup  action="UpdateCostHeadGroup.jsp" method=post onsubmit="return Validate();">
<% 

String message=request.getParameter("message"); 
//String name   = request.getParameter("name"); 
int srno=1;
String selectquery ="Select * from Master_CostHeadGroup where company_id=?"; 
...
<tr bgcolor=skyblue>
<th colspan=4>Add New CostHead Group </th>
</tr>
...
<td colSpan=3><input type=text name=costheadgroup_name size=25 ></td>
</tr>

<tr>
<td>Code <font class="star1">*</font></td>
<td colSpan=3><INPUT type=text name=costheadgroup_code size=25 >
...
<td colSpan=3><INPUT type=text name=costheadgroup_description size=25 >
<input type=hidden name=sr_no size=6 value='1'>
</td>
</tr>
