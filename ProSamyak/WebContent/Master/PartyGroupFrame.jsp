...
<Html>
	<Body bgcolor=#FFD3A8>
		...
		<%java.sql.Date D4 = new java.sql.Date(System.currentTimeMillis()); %>
			...
			<IFRAME name=top  src="../Master/NewPartyGroup.jsp?command=Default&message=Default" marginwidth="0" marginheight="10" hspace="0" vspace="0" frameborder="0" scrolling="no" width='100%'  height='10%'>
			
			

			<IFRAME name=bottom  src="../Finance/PartyGroupType.jsp?command=Default&message=Default" marginwidth="0" marginheight="0" hspace="0" vspace="0" frameborder="0" scrolling="auto" width='100%' height='90%'>
