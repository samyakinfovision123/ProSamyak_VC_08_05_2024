...
//String categoy_id= ""+L.get_master_id("Master_ItemLocation");
...
int srno=1;
String selectquery ="Select * from Master_Location where company_id=?"; 
...
%>
<center>
<FONT SIZE="2.5" COLOR="RED"><B><%=message%></B></FONT>
</center>
<%
		}
%>
...
<tr bgcolor=skyblue>
<th colspan=4>Add New Location </th>
</tr>
...
<td colSpan=3><input type=text name=location_name size=25 ></td>
</tr>

<tr>
<td>Code <font class="star1">*</font></td>
<td colSpan=3><INPUT type=text name=location_code size=25 >
...
<td colSpan=3><INPUT type=text name=location_description size=25 >
<input type=hidden name=sr_no size=6 value='1'>
</td>
</tr>
