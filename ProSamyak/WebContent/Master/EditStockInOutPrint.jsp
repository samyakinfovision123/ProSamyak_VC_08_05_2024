...
<td>
	<%=++i%></td>
<td><A href= "../Master/EditStock_InOutFormPrint.jsp?Receive_Id=<%=receive_id%>&StockTransfer_Type=<%=StockTransfer_Type%>&voucher_no=<%=voucher_no%>&command=Default&mesage=Default" target=_self><%=voucher_no%></td></td>
