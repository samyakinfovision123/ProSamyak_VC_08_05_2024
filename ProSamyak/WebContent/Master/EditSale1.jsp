...
//	cong=C.getConnection();
	...
	out.println("<font color=red> FileName : EditSale1.jsp<br>Bug No e31 : "+ e31);}
...
<tr><td>
	<form action=EditSale1.jsp name=f1 method=post >
	...
	<tr><th>Account</th>
    <TD align="center">   
<%=A.getMasterArrayAll(conp,"Companyparty","party_id","",company_id)
%> </td></tr>
...
if("Edit Sale".equals(command))
	...
	cong=C.getConnection();
	conp=C.getConnection();
//out.print("<br>94 welcome to sale");
...
//out.print("<br>107 party_id="+party_id);
double total_saleaccount=0;
//String Category_Code= request.getParameter("category_code");
//out.print("<br>118 Category_Code="+Category_Code);
...
query="Select * from Receive  where Receive_Date between ? and ? and Company_id=? and Purchase=1  and Receive_Sell=0 and Active=1 and R_Return=0 and  Consignment_ReceiveId=0 order by Receive_Date,Receive_No,Receive_Id";
...
query="Select * from Receive  where Receive_Date between ? and ? and Company_id=?  and Receive_FromId="+party_id+" and Purchase=1 and Receive_Sell=0 and Active=1 and R_Return=0 and  Consignment_ReceiveId=0 order by Receive_Date,Receive_No,Receive_Id";
...
//out.print("<br>187 Receive_id="+Receive_id);
boolean proactive = rs_g.getBoolean("ProActive");
//out.print("<br>189 proactive="+proactive);
int Iv_id=0;
int Fv_id=0;
...
//if(proactive)
//{
	//out.print("<br>196 proactive="+proactive);
...
while(rs_p.next())
{
	...
	//out.print("<br>201 Voucher_Id="+Iv_id);
	}
pstmt_p.close();
...
//out.print("<br>227 receive_from="+receive_from);
...
//out.print("<br>240 reportcurrency_id="+reportcurrency_id);
if(reportcurrency_id==0)
{

%>
<%
	//out.print("<br>245 Receive_id="+Receive_id);
...
//out.print("<br>237 pdcount "+cashflag);
...
<td>
	...
	if ("3".equals(category_code))
		{%>
<td><A href= "NewEditSaleForm1.jsp?command=sedit&receive_id=<%=Receive_id%>&Iv_id=<%=Iv_id%>&Fv_id=<%=Fv_id%>&message=Default" target=_self>
	<%=rs_g.getString("Receive_no")%></a></td>

	<%}
	else{%>
<td><A href= "EditSaleForm1.jsp?command=sedit&receive_id=<%=Receive_id%>&Iv_id=<%=Iv_id%>&Fv_id=<%=Fv_id%>" target=_blank>
	<%=rs_g.getString("Receive_no")%></a></td>
...
String Receive_id =rs_g.getString("Receive_id");
//out.print("<br><font color=red>331 Receive_id= </font>"+Receive_id);
boolean proactive = rs_g.getBoolean("ProActive");
//out.print("<br>");
//out.print("<br>336 proactive="+proactive);
int Iv_id=0;
int Fv_id=0;
...
String v_query="select Voucher_Id from Voucher where Voucher_No='"+Receive_id+"' and Voucher_Type=1 and Active=1";
//out.print("<br>");
//out.print("<br>345 v_query="+v_query);
...
String receive_from=rs_g.getString("Receive_FromId");
//out.print("<br><font color=#6666FF>371 receive_from=</font>"+receive_from);
String rec_no=rs_g.getString("Receive_no");
//out.print("<br>372 rec_no="+rec_no);
if(receive_from.equals(company_id))
{}
else{
if(reportcurrency_id==0)
...
String pdquery="select *  from Payment_Details where For_HeadId="+Receive_id+" and Active=1";
//out.print("<br>388 pdquery= "+pdquery);
pstmt_p=conp.prepareStatement(pdquery);
rs_p=pstmt_p.executeQuery();
double pdcount=0;
while(rs_p.next())
	...
	pstmt_p.close();
	//out.print("<br>423 cashflag "+cashflag);
//out.print("<br>426 pdcount "+pdcount);
//if((pdcount>=0) || (cashflag))
	//{//out.print("<br>Hello");
%>
...
///out.print("<br>477 receive_id="+receive_id);
...
out.println("<font color=red> FileName : EditSale1.jsp command=sedit<br>Bug No e631 : "+ e631);}
%>
</BODY>
</HTML>