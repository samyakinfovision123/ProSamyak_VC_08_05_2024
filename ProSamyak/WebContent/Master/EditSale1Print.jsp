...
query="Select * from Receive  where Receive_Date between ? and ? and Company_id=? and Purchase=1 and Receive_Internal=0 and Receive_Sell=0 and Active=1 and R_Return=0  order by Receive_Date,Receive_No,Receive_Id";
...
query="Select * from Receive  where Receive_Date between ? and ? and Company_id=? and Receive_Internal=0 and Receive_FromId="+party_id+" and Purchase=1 and Receive_Sell=0 and Active=1 and R_Return=0  order by Receive_Date,Receive_No,Receive_Id";
...
<td>
	...
	if ("3".equals(category_code))
		{%>
<td><A href= "NewEditSaleForm1Print.jsp?command=sedit&receive_id=<%=Receive_id%>&Iv_id=<%=Iv_id%>&Fv_id=<%=Fv_id%>" target=_self>
