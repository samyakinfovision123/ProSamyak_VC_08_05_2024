...
<Html>
	<Body bgcolor=#FFD3A8>
		...
		%>
			...
			<IFRAME name="effrate_header"  src="Efective_Rate.jsp?Flag=false&message=Default" marginwidth="0" marginheight="100" hspace="0" vspace="0" frameborder="0" scrolling="no" width='20%' height='100%' align='left'>
			
			

			<IFRAME name="effrate_display" src="../Home/Blank.html" marginwidth="0" marginheight="50" hspace="0" vspace="0" frameborder="0" scrolling="no" width='80%' height='100%' align='right'>
