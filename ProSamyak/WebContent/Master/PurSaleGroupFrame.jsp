...
<Html>
	<Body bgcolor=#FFD3A8>
		...
		%>
			...
			<IFRAME name=top  src="../Master/NewPurSaleGroup.jsp?command=Default&message=Default&purchasesalegroup_type=<%=purchasesalegroup_type%>" marginwidth="0" marginheight="10" hspace="0" vspace="0" frameborder="0" scrolling="no" width='100%'  height='20%'>
			
			

			<IFRAME name=bottom  src="../Finance/PurchaseSaleGroupType.jsp?command=Default&message=Default&purchasesalegroup_type=<%=purchasesalegroup_type%>" marginwidth="0" marginheight="0" hspace="0" vspace="0" frameborder="0" scrolling="auto" width='100%' height='80%'>
