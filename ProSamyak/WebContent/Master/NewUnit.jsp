...
int srno=1;
String selectquery ="Select * from Master_unit where company_id=?"; 
...
<tr bgcolor=skyblue>
<th colspan=4>Add New Unit of Measurment </th>
</tr>
...
<td colSpan=3><input type=text name=unit_name size=25 ></td>
</tr>

<tr>
<td>Code <font class="star1">*</font></td>
<td colSpan=3><INPUT type=text name=unit_code size=25 >
...
<td colSpan=3><INPUT type=text name=unit_description size=25 >
<input type=hidden name=sr_no size=6 value='1'>
</td>
</tr>
...
<input type=submit name=command value='Add Unit' class='Button1'>
</td>
</tr>
