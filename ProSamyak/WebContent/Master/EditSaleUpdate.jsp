...
//String SendForLocation_id = request.getParameter("Location_Id");
//out.print("<br> 119 Location_id = "+SendForLocation_id);
...
{
	errLine="539";
//System.out.print("#### findeleted["+i+"]="+findeleted[i]);
if("yes".equals(findeleted[i]))
{
	//System.out.print("#### findeleted["+i+"]="+findeleted[i]);
	//System.out.print("#### org_transacionid["+i+"]="+org_transacionid[i]);
...
//out.print("<br>currency_id"+currency_id);
		...
		pstmt_p.setString(30,SendForLocation_id);
		pstmt_p.setString(31,description);
		pstmt_p.setString(32,""+receive_id);
...
if(currency.equals("local"))
	{
		...
		{
			//System.out.println("914 Upadte receive fro PoaActive=0 fro local");
	...
	if(currency.equals("dollar"))
	{
		...
		{
			//System.out.println("914 Upadte receive fro PoaActive=0 fro Dollar");
...
errLine="1229";	cong.setTransactionIsolation(java.sql.Connection.TRANSACTION_READ_COMMITTED);
	C.returnConnection(conp);
...
out.println("<br><font color=red> errLine at "+errLine+" FileName : EditSaleUpdate.jsp Bug No Samyak499 : "+ Samyak499);
}
}//end if ('Update')
