...
//out.print("<br>121 ref_no="+ref_no);
String description=
...
//System.out.println("4444444444444444444444444444444444Update");
	...
	//System.out.println("<br>692 ");
		...
		//out.print("<br>721 "+newlocation_id[i]);
...
//		out.print(" <br>quantity[i] "+quantity[i] );
		pstmt_p.setDouble(7,quantity[i]);
//		out.print(" <br>quantity[i] "+quantity[i] );
...
out.println("<br><font color=red> FileName : InvSellUpdate.jsp Bug No Samyak499 : "+ Samyak499+"errline="+errline);
}
}//end if ('Update')
