...
<Html>
	<Body bgcolor=#FFD3A8>
		...
		%>
			...
			<IFRAME name=top  src="CompanyPartyHeader.jsp?command=Default&message=Defalut" marginwidth="0" marginheight="10" hspace="0" vspace="0" frameborder="0" scrolling="no" width='100%'  height='10%'  >
			
			

			<IFRAME name=bottom  src="../Master/NewCompanyPartyAccount.jsp?message=Default&account_no=Party" marginwidth="0" marginheight="0" hspace="0" vspace="0" frameborder="0" scrolling="auto" width='100%' height='90%' >
