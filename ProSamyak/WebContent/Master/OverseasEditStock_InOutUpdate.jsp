...
//============================================================
	...
	//System.out.print("sremark"+sremark[i]);		
	...
	System.out.println("Tolocation"+to_location[i]);
	...
	// System.out.print("dremark"+dremark[i]);
		//dlocation_id[i]=request.getParameter("dlocation_id"+i);
	// System.out.print("247 dlocation_id"+dlocation_id[i]);
	...
	pstmt_p.setString (23,""+from_location[i]);
...
/* For Insert New Rows*/
	...
	//pstmt_p.setString (24,""+slocation_id[i]);		
	pstmt_p.setString (24,""+from_location[i]);
...
//	testvoucher_id=L.get_master_id(conp,"Voucher");
	...
	pstmt_p.setString (23,""+to_location[i]);
	errLine="1014";
	pstmt_p.setBoolean (24, true);		
	pstmt_p.setString (25,"0");//Consignment_ReceiveId		
	pstmt_p.setString (26,""+yearend_id);//yearend_id		
...
/* For Insert New Rows*/
	...
	pstmt_p.setString (23,""+machine_name);		
	//pstmt_p.setString (24,""+slocation_id[i]);		
	pstmt_p.setString (24,""+to_location[i]);
	pstmt_p.setBoolean (25, true);		
	...
	errLine="1232";
	response.sendRedirect("OverseasEditStockInOut.jsp?command=StockInOutReport&Receive_No="+stocktransfer_no);
	%>
